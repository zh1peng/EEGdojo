classdef Params
    ...
    properties
        ...
        Chan2remove         {mustBeA(Chan2remove, ["double", "cell"])}
    ...
    methods
        function obj = Params(params)
            ...
            addParameter(P, 'Chan2remove', {}, @(x) isnumeric(x) || iscellstr(x));
            ...
            defaultBadChan = struct(...
                ...
                'NormOn', 'on', ...
                'FASTER_MeanCorr', false, ...
                'FASTER_Threshold', 0.4, ...
                'FASTER_Variance', false, ...
            ...
            defaultBadIC = struct(...
                ...
                'FASTEROn', true, ...
                'DetectECG', false, ...
                'ECGStruct', [], ... % New: Placeholder for external ECG data structure
