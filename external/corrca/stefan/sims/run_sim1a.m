...
clear K_shift K_phase K_param K_spectral A_acc Y_acc ISC_av ISC ISC_av_test ISC_test A_subspace A_subspace_regr Y_subspace Y_subspace_regr
for ik = 1:length(Ks)
  for irep = 1:Nrep
...
save('mat/sim1a_results', 'K_shift', 'K_phase', 'K_param', 'K_spectral', 'A_acc', 'A_subspace', 'A_subspace_regr', ...
