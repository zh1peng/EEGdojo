function run_sim8
% Gaussian colored (pink) signal and noise time series,
...
for idistr = 1:length(distrs)
  ...
  for irep = 1:Nrep
    ...
    switch idistr
      ...
      case 2
        [data, Y_true, A_true] = gen_data(2*T, D, N, ones(1, K), snr, 0, 1, 0, 1, 'Gauss');
      case 3
        [data, Y_true, A_true] = gen_data(2*T, D, N, ones(1, K), snr, 0, 0, 1, 1, 'Gauss');
      case 4
        [data, Y_true, A_true] = gen_data(2*T, D, N, ones(1, K), snr, 0, 0, 0, 1, 'Gauss');
    end
...
save('mat/sim8b_results', 'K_shift', 'K_phase', 'K_param', 'K_spectral', 'Y_acc', ...
