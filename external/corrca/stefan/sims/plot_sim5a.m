...
export_fig('../../figures/simulations/sim5a_K', '-r300', '-a2');
...
export_fig('../../figures/simulations/sim5a_ISC', '-r300', '-a2');
...
export_fig('../../figures/simulations/sim5a_recon', '-r300', '-a2');
