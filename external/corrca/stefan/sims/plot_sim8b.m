...
set(l, 'FontSize', 20)
export_fig('../../figures/simulations/sim8b_K', '-r150', '-a2');
...
set(l, 'FontSize', 20)
export_fig('../../figures/simulations/sim8b_ISC', '-r150', '-a2');
...
set(l, 'FontSize', 20)
export_fig('../../figures/simulations/sim8b_recon', '-r150', '-a2');
