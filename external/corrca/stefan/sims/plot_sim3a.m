...
ax = reshape(axis, 2, 2);
text(10.^(log10(ax(1, 1)) - diff(log10(ax(:, 1)))*0.125), ax(1, 2) + diff(ax(:, 2))*1.025, 'A', 'fontsize', 30)
export_fig('../../figures/simulations/sim3a_K', '-r300', '-a2');
...
export_fig('../../figures/simulations/sim3a_ISC', '-r300', '-a2');
...
export_fig('../../figures/simulations/sim3a_recon', '-r300', '-a2');
