...
Params.ChanInfo.Chan2remove = {'E129'}; % Channels to remove (e.g., {'ref''} 
Params.ChanInfo.ECGChanLabel = {};
Params.ChanInfo.OtherChanLabel = {};

%% continuse data
Params.Crop.StartMarker = 'bgin'; 
Params.Crop.EndMarker   = '';
...
Params.EpochTask.Markers = {'C101', 'C102', 'C103', 'FB10', 'FB11', 'FB20', 'FB21', 'FB30', 'FB31'}; % Event markers for epoching
Params.EpochTask.TimeWindow = [-1, 2]; % Time window for epoch extraction relative to marker (seconds)
