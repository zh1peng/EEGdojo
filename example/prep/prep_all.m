...
for t = 1:numel(tasks)
    ...
    parfor i = 1:numel(subfile)
        ...
        ecg_pipe = prep.Pipeline([], p_ecg) ...
            .addStep('Load',              @IO.load_set,          p_ecg.Input) ...
            ...
            .addStep('Save ECG',          @IO.save_set,          p_ecg.Output) ...
            .run();
        ...
        eeg_pipe = prep.Pipeline([], p_eeg) ...
            .addStep('Load',               @IO.load_set,          p_eeg.Input) ...
            ...
            .addStep('Save',               @IO.save_set,          p_eeg.Output) ...
            .run();
